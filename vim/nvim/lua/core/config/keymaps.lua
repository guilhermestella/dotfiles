...
-- Resize
vim.keymap.set({ "t", "n" }, "<C-Up>", ":resize -2<CR>", { desc = "Increase height" })
vim.keymap.set({ "t", "n" }, "<C-Down>", ":resize +2<CR>", { desc = "Decrease height" })
vim.keymap.set({ "t", "n" }, "<C-Left>", ":vertical resize -2<CR>", { desc = "Decrease width" })
vim.keymap.set({ "t", "n" }, "<C-Right>", ":vertical resize +2<CR>", { desc = "Increase width" })
